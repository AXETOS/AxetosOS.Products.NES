...
public sealed class VirtualHardwareRp2C07StandaloneTests
{
    [Fact]
    ...
    [Fact]
    public void Pal_Oamdata_attribute_reads_mask_unimplemented_bits_two_through_four()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public void Pal_Greyscale_palette_ppudata_read_masks_color_bits_before_open_bus_merge()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public void Pal_rendering_frames_never_skip_the_final_pre_render_cycle()
    {
        var fixture = new Fixture();
        fixture.WriteRegister(1, 0x08);

        fixture.PulseClock(341 * 312);
    ...
    [Fact]
    public void Pal_colour_emphasis_swaps_the_physical_red_and_green_controls()
    {
        var fixture = new Fixture();

        fixture.WriteRegister(1, 0x20);
        Assert.Equal((byte)0x02, fixture.Chip.ColorEmphasis);

        fixture.WriteRegister(1, 0x40);
        Assert.Equal((byte)0x01, fixture.Chip.ColorEmphasis);

        fixture.WriteRegister(1, 0x80);
        Assert.Equal((byte)0x04, fixture.Chip.ColorEmphasis);
    }

    [Fact]
    public void Pal_vblank_remains_asserted_until_the_312_line_pre_render_scanline()
    {
        var fixture = new Fixture();
        fixture.PulseClock((241 * 341) + 1);
        Assert.True(fixture.Chip.Vblank);

        fixture.PulseClock((70 * 341) - 1);
        Assert.True(fixture.Chip.Vblank);
        Assert.Equal(311, fixture.Chip.Scanline);
        Assert.Equal(0, fixture.Chip.Dot);
